...
## 参考与问题报告
Typst是排版软件的新起之秀，**优美的语法和惊人的速度**是它最大的优点。`Word`在排版大规模高度格式化的文本（例如论文）有先天的劣势，浪费人的寿命。$\LaTeX$虽然可以进行高质量的排版，但是使用体验不是那么好，它的语法比较丑陋，编译速度很慢，报错信息很难看，调试起来很困难。使用Typst有足够的理由！然而请注意：**Typst比较新，出了问题你可能不能马上找到答案，你可能需要求助于社区。这些链接可能对你有帮助**：
...
虽然现在Typst有这样的问题，但是有理由相信Typst会越来越好，生态越来越丰富，你能白嫖的模板越来越多！😋
